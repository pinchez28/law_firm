...
from .views.admin.lawyers.admin_change_lawyer_status_view import AdminChangeLawyerStatusView
...
urlpatterns = [
    ...
    # Employment Status
    path(
        "lawyers/<uuid:lawyer_id>/change-status/",
        AdminChangeLawyerStatusView.as_view(),
