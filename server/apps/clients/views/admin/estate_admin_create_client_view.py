...
from apps.clients.serializers.admin.estate_admin_create_client_serializer import (
...
class EstateAdminCreateClientView(ClientAdminBaseView):
    def post(self, request):
        serializer = EstateAdminCreateClientSerializer(data=request.data)
