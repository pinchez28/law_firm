...
from apps.clients.serializers.admin.partnership_admin_create_client_serializer import (
...
class PartnershipAdminCreateClientView(ClientAdminBaseView):
    def post(self, request):
        serializer = PartnershipAdminCreateClientSerializer(data=request.data)
