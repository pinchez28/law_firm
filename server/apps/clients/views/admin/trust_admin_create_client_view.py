...
from apps.clients.serializers.admin.trust_admin_create_client_serializer import (
...
class TrustAdminCreateClientView(ClientAdminBaseView):
    def post(self, request):
        serializer = TrustAdminCreateClientSerializer(data=request.data)
